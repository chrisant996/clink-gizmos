...
local stopTime = 0
-- begin_clink_change
local startDateTime = 0
local stopDateTime = 0
-- end_clink_change
local printFun = nil
...
-- begin_clink_change
  fileWriter:write("> Start:  "..os.date("%c", startDateTime).."\n")
  fileWriter:write("> Stop:   "..os.date("%c", stopDateTime).."\n")
-- end_clink_change
