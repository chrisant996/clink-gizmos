...
local source = {
    ...
    { { 'pp:', 'preprocess:', file },                   'Write an aggregated project file by inlining all the files that would be imported, with their boundaries marked' },
    { { 'ts', 'targets' },                              'List the available targets without executing the actual build process' },
    { { 'ts:', 'targets:', file },                      'Write to the specified file a list of available targets without executing the actual build process' },
    ...
    { { 'profileEvaluation:', file },                   'Profiles MSBuild evaluation and writes the result to the specified file (.md ext for markdown format)' },
    { { 'interactive' },                                'Actions in the build are allowed to interact with the user' },
    { { 'interactive:', tf }, 'true|false',             'Indicates whether actions in the build are allowed to interact with the user' },
